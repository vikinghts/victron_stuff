...
def main():
  ...
  try:
      ...
      # Define paths for the DbusShellypmService
      paths = {
      ...
      # Instantiate the DbusShellypmService
      service = DbusShellypmService(
            servicename='com.victronenergy.pvinverter',
            paths=paths,
            productname='Shelly 1PM',
            connection='Shelly 1PM HTTP JSON service'
      )
